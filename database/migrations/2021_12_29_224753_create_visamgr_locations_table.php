...
class CreateVisamgrLocationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('visamgr_locations', function (Blueprint $table) {
            ...
            $table->longText('COUNTRIES_TRAVELLED')->nullable(); //ANY_OTHER_COUNTRY_VISITED
            $table->longText('LAST_FIVE_VISITS')->nullable();
    ...
    {
        Schema::dropIfExists('visamgr_locations');
    }
}
