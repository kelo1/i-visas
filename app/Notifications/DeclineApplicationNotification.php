...
class DeclineApplicationNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line('Kindly, note that your visa application has been denied, click on the link below for further information')
