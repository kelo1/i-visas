...
class PrescreeningNotification extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct(Client $client, Messages $message, $client_name, $toAddress, $fromAddress, $subject)
    {
        $this->client = $client;
